<div id="content">
			...
			<div class="detail_image full">
				    <img src="http://slash_media/hls/trailers/maleficent/poster.png" />
				    <video src="http://slash_media/hls/trailers/maleficent/maleficent.m3u8" preload="none" controls poster="http://slash_media/hls/trailers/maleficent/poster.png"></video>
				</div>
			...
			<!--    <div class="detail_buttons clearfix">
			    ...
			    <div class="detail_disclaimer">
			    	<ul class="detail_disclaimer_list">
				    	...
				    	<li><span class="disclaimer_bold">Director:</span> Robert Stromberg</li>
				    	<li><span class="disclaimer_bold">Running time:</span> 135 minutes</li>
				    	<li><span class="disclaimer_bold">MPAA rating:</span> PG</li>
				    	<li><span class="disclaimer_bold">Costume design:</span> Anna Biedrzycka-Sheppard</li>
			   		</ul>
			    </div>
			    </div>
