<div id="content">
				...
				<div class="detail_image full">
				    <img src="http://slash_media/hls/trailers/earthtoecho/poster.png" />
				    <video src="http://slash_media/hls/trailers/earthtoecho/captainamerica.m3u8" preload="none" controls poster="http://slash_media/hls/trailers/earthtoecho/poster.png"></video>
				</div>
			...
			<hr class="dividerline"></hr>
			    ...
			    <div class="detail_disclaimer">
			    	<ul class="detail_disclaimer_list">
				    	<li><span class="disclaimer_bold">Release date:</span> July 2, 2014 (USA)</li>
				    	<li><span class="disclaimer_bold">Director:</span> David Green</li>
				    	<li><span class="disclaimer_bold">Music composed by:</span> Joseph Trapanese</li>
				    	<li><span class="disclaimer_bold">MPAA rating:</span> PG</li>
				    	<li><span class="disclaimer_bold">Screenplay:</span> Henry Gayden</li>
			   </ul>
			    </div>
			    </div>
