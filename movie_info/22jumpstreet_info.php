			...
			<!--    <div class="detail_buttons clearfix">
			    ...
			    <div class="detail_disclaimer">
			    	<ul class="detail_disclaimer_list">
				    	...
				    	<li><span class="disclaimer_bold">Directors:</span> Chris Miller, Phil Lord</li>
				    	<li><span class="disclaimer_bold">Music composed by:</span> Mark Mothersbaugh</li>
				    	<li><span class="disclaimer_bold">Screenplay:</span> Rodney Rothman, Oren Uziel, Michael Bacall</li>
				    	<li><span class="disclaimer_bold">Story by:</span> Michael Bacall, Stephen J. Cannell, Jonah Hill, Patrick Hasburgh</li>
			   </ul>
			    </div>
			    </div>
